...
namespace KnitupFramework.IO
{
    ...
    public class FileExtension
    {
        ...
        private static IDictionary<String, String> cDicMappings = new Dictionary<String, String>(StringComparer.InvariantCultureIgnoreCase) {
            {".323", "text/h323"},
            {".3g2", "video/3gpp2"},
            {".3gp", "video/3gpp"},
            {".3gp2", "video/3gpp2"},
        ...
        public FileExtensionGroup Group { get; private set; }

        public String MimeType
        {
            get
            {
                return (GetMimeType(String.Format(".{0}", Extension)));
            }
        }
        ...
        public FileExtension(String iExtension,
            String iShortDescription,
            String iLongDescription = "",
            FileExtensionGroup iGroup = null)
        {
        ...
        public static String GetMimeType(String iExtension)
        {
            if (iExtension == null)
            {
                throw new ArgumentNullException("iExtension");
            }
            ...
            String pStrMime;
            Boolean pBlnFoundMimeType = cDicMappings.TryGetValue(iExtension, out pStrMime);
            return (pBlnFoundMimeType ? pStrMime : "application/octet-stream");
        }
